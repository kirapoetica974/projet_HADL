...
public class Security_Query_Called_Security_Manager extends Role_Fourni {

	public Security_Query_Called_Security_Manager() {
		super();
		this.setNom("Security_Query_Called_Security_Manager");
	}
