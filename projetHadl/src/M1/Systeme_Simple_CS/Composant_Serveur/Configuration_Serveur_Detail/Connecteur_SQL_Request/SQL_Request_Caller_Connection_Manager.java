...
public class SQL_Request_Caller_Connection_Manager extends Role_Requis {

	public SQL_Request_Caller_Connection_Manager() {
		super();
		this.setNom("SQL_Request_Caller_Connection_Manager");
	}
}
